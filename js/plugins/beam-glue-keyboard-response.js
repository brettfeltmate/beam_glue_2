    ...
    plugin.trial = function (display_element, trial) {
        ...
        $("head").append(
            $("<style />").attr(`id`, `beam-glue-keyboard-response-styles`).html(
                ...
                `\tmargin: auto;\n` +
                `\ttext-align: center;\n` +
                `\tline-height: ${Math.ceil(2 * plugin.one_dva)}px;\n` +
                `\talign-items: center;\n` +
                `\tplace-items: center;\n` +
                `}\n\n` +
                `.array {\n` +
                ...
                `.cross {\n` +
                `\tbackground: white;\n` +
                `\theight: ${Math.ceil(0.6 * plugin.one_dva)}px;\n` +
                `\tposition: relative;\n` +
                `\twidth: ${Math.ceil(0.1 * plugin.one_dva)}px;\n` +
                `\tmargin: auto;\n` +
                `\ttop: 35%;\n` +
                `}\n\n` +
                `.cross::after {\n` +
                `\tbackground: white;\n` +
                `\tcontent: "";\n` +
                `\theight: ${Math.ceil(0.1 * plugin.one_dva)}px;\n` +
                `\tleft: -${Math.ceil(0.25 * plugin.one_dva)}px;\n` +
                `\tposition: absolute;\n` +
                `\ttop: ${Math.ceil(0.25 * plugin.one_dva)}px;\n` +
                `\twidth: ${Math.ceil(0.6 * plugin.one_dva)}px;\n` +
                `}\n\n` +
                `.cue-right {\n` +
                `\twidth: ${Math.ceil(0.6 * plugin.one_dva)}px;\n` +
                `\tposition: relative;\n` +
                ...
                `.cue-right::before {\n` +
                `\tcontent: "";\n` +
                `\tmargin-top: ${Math.ceil(0.25 * plugin.one_dva)}px;\n` +
                `\twidth: ${Math.ceil(0.3 * plugin.one_dva)}px;\n` +
                `\tbackground: white;\n` +
                `\theight: ${Math.ceil(0.1 * plugin.one_dva)}px;\n` +
                `\tfloat: left;\n` +
                `}\n\n` +
                ...
                `\twidth: 0;\n` +
                `\theight: 0;\n` +
                `\tborder-top: ${Math.ceil(0.3 * plugin.one_dva)}px solid transparent;\n` +
                `\tborder-bottom: ${Math.ceil(0.3 * plugin.one_dva)}px solid transparent;\n` +
                `\tborder-left: ${Math.ceil(0.3 * plugin.one_dva)}px solid white;\n` +
                `\tfloat: right;\n` +
                `}\n\n` +
                `.cue-left {\n` +
                `\tposition: relative;` +
                ...
                `\tborder-top: ${Math.ceil(0.3 * plugin.one_dva)}px solid transparent;\n` +
                `\tborder-bottom: ${Math.ceil(0.3 * plugin.one_dva)}px solid transparent;\n` +
                `\tborder-right: ${Math.ceil(0.3 * plugin.one_dva)}px solid white;\n` +
                `\tfloat: left;\n` +
                `}\n\n` +
                `.cue-left::after {\n` +
                `\tcontent: "";\n` +
